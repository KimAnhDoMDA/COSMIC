...
feature_row1:
  ...
  - image_path: ./assets/images/misc/blank.JPG
    alt: "Article 2"
    image_caption: "Published 8-6-2025"
    title: "Bias in Meta-Analytic Modeling of Surrogate Endpoints in Cancer Screening Trials"
    excerpt: "In this work, we show via simulation and theory that trial-level estimate uncertainty may bias the results of meta-analytic models towards positive findings of the quality of the surrogate."
    url: "https://arxiv.org/abs/2508.04633"
  - image_path: ./assets/images/misc/blank.JPG
    alt: "Article 3"
    image_caption: "Published on 7-18-2025"
    title: "Oral microbial signatures of head and neck cancer patients with diverse longitudinal oral mucositis severity patterns"
    excerpt: "This study aimed to: (1) characterize longitudinal microbial patterns of oral mucositis severity among head and neck cancer patients; (2) determine clinically relevant patient clusters based on oral mucositis severity trajectories; and (3) identify microbial signatures specific to these clusters."
    url: "https://pubmed.ncbi.nlm.nih.gov/40791415/"
  - image_path: ./assets/images/misc/blank.JPG
    alt: "Article 4"
...
<div class="custom-feature">
    <a href="https://imstat.org/2026/05/19/congratulations-to-the-2026-class-of-ims-fellows/" rel="external" target="_blank">
    <h3 class="in-the-news" >Kim-Anh Do honored as a 2026 IMS Fellow
    <svg class="external-icon" aria-hidden="true" width="12" height="12" viewBox="0 0 12 12">
     <path d="M3 3h6v6M3 9L9 3" stroke="currentColor" fill="none" stroke-width="1.5"/>
    </svg>
    <span class="sr-only">(opens in a new tab)</span>
    </h3></a>
    <p class="posted-date">Posted 09-03-2026</p>
    <p class="responsive-text" >The designation of IMS Fellow has been a significant honor for 90 years. Each Fellow has demonstrated distinction in research in statistics or probability or has demonstrated leadership that has profoundly influenced the field.</p>

    <a href="https://www.youtube.com/watch?v=frB8eJ0k9W0" target="_blank">
    <h3 class="in-the-news">Kim-Anh Do selected to receive the Janet L. Norwood Award for 2024!
    <svg class="external-icon" aria-hidden="true" width="12" height="12" viewBox="0 0 12 12">
     <path d="M3 3h6v6M3 9L9 3" stroke="currentColor" fill="none" stroke-width="1.5"/>
    </svg>
    <span class="sr-only">(opens in a new tab)</span>
    </h3></a>
    <p class="posted-date">Posted 08-13-2024</p>
    <p class="responsive-text" >This award is given annually and recognizes outstanding achievement by a woman in the statistical sciences. Click the link for the award ceremony</p>

    <a href="https://www.mdpi.com/2072-6694/16/11/2070" target="_blank">
    <h3 class="in-the-news">Our Groundbreaking Article on Lethal Lung Cancer Biomarkers Published in Cancers Journal's Special Issue!
    <svg class="external-icon" aria-hidden="true" width="12" height="12" viewBox="0 0 12 12">
     <path d="M3 3h6v6M3 9L9 3" stroke="currentColor" fill="none" stroke-width="1.5"/>
    </svg>
    <span class="sr-only">(opens in a new tab)</span>
    </h3></a>
    <p class="posted-date">Posted 05-30-2024</p>
    <p class="responsive-text" >Click on the title to read more about the Validation of a Blood-Based Protein Biomarker Panel for a Risk Assessment of Lethal Lung Cancer in the Physicians’ Health Study</p>
    ...
    <h3 class="in-the-news">Our Research Study Earns a Place in MD Anderson's 23 Cancer Research Highlights of 2023!
    <svg class="external-icon" aria-hidden="true" width="12" height="12" viewBox="0 0 12 12">
     <path d="M3 3h6v6M3 9L9 3" stroke="currentColor" fill="none" stroke-width="1.5"/>
    </svg>
    <span class="sr-only">(opens in a new tab)</span>
    </h3></a>
    <p class="posted-date">Posted 12-21-2023</p>
    <p class="responsive-text" >Read more about it on the MD Anderson website: Blood test developed at MD Anderson aids in predicting lung cancer mortality risk</p>
</div>
